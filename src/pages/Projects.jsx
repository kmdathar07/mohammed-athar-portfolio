      ...
      >
        ...
        >
          ...
          <div className="p-8">
            ...
            <p className="text-[#E6E6E6]/70 leading-relaxed mb-6">
              {project.description}
            </p>
    ...
    <PageTransition>
      <div className="page-full bg-projects overflow-y-auto">
        ...
        <div className="max-w-7xl mx-auto px-6 pt-28 pb-20 relative z-10">
          ...
          >
            ...
            <div className="flex flex-col md:flex-row md:items-end justify-between gap-4">
              ...
              <p className="text-slate text-base max-w-xs mb-2">
                Click any card for full details. Real projects with source code and live demos.
              </p>
            </div>
          </motion.div>
          ...
          >
            <a
              href="https://github.com/kmdathar07"
              target="_blank"
              rel="noopener noreferrer"
